...
from google.adk.models import VertexAI  # Import provider VertexAI bawaan ADK
import google.auth
...
root_agent = LlmAgent(
    client = genai.Client(vertexai=True, project="deploy-ai-agent-506711", location="us-central1")
